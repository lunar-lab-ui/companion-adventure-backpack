...
""",
        "choices": {
            ...
            "C": ("还是把第二套餐具摆好", "accept", 1, "Rowan 还是把第二套餐具摆好。动作很稳。可碗里的热气升起来时，他忽然意识到：承认她的位置，不等于她真的能坐在这里。这不是不疼，是疼着也不撤掉她的位置。"),
        },
...
V201_VERSION = "v2.0.1 — Shared Vigil & Immersive Polish"
...
if __name__ == "__main__":
    print("小狐狸探险背包 · AI-playable core v2.0.1 - Shared Vigil & Immersive Polish")
