...
AI-playable core v1.7.1.1 - Home Choice Polish & Public Tester Notes
...
def _legacy_help_text() -> str:
    return """🎒 小狐狸探险背包 · AI-playable core v1.7.1.1 - Home Choice Polish & Public Tester Notes
...
def public_notes() -> str:
    return """📦 v1.7.1 Public Tester Notes
...
7. v1.7.1 增加 Home AU 的“承认也有代价”文本，并说明 Screen awareness / Plush presence 的实际作用。
...
if __name__ == "__main__":
    print("小狐狸探险背包 · AI-playable core v1.7.1.1 - Home Choice Polish & Public Tester Notes")
