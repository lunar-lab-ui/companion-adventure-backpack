...
AI-playable core v1.7 - Home Polish, Public Tester Guide & AU Focus Map
...
def _legacy_help_text() -> str:
    return """🎒 小狐狸探险背包 · AI-playable core v1.7 - Home Polish, Public Tester Guide & AU Focus Map
...
def public_notes() -> str:
    return """📦 v1.7 Public Tester Notes
...
if __name__ == "__main__":
    print("小狐狸探险背包 · AI-playable core v1.7 - Home Polish, Public Tester Guide & AU Focus Map")
