...
AI-playable core v1.8.1 - Home Choice Polish & Public Tester Notes
...
def _legacy_help_text() -> str:
    return """🎒 小狐狸探险背包 · AI-playable core v1.8.1 - Home Choice Polish & Public Tester Notes
...
if __name__ == "__main__":
    print("小狐狸探险背包 · AI-playable core v1.8.1 - Home Choice Polish & Public Tester Notes")
